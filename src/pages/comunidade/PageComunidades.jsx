      ...
      <Container>
        ...
        <SectionPrimeira>
          ...
          <Div>
            ...
            <p><a href={site} target="_blank" rel="noreferrer noopener"><span>"Autocuidado deve ser o cuidado consigo mesma, atenção às próprias necessidades do corpo, mentais e psicológicas." </span></a>
          ...
          <Divi>
            ...
            <p>No <a href={site1} target="_blank" rel="noreferrer noopener"><span>Outubro Rosa</span></a>,médicas refletem sobre como é preciso estruturar a rotina para cuidar da saúde e prevenir o câncer 
