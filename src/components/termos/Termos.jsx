...
import { Container, Span } from '../comunidade/StyledComunidade'
import { FormFieldset, FormButton } from '../login/StyledForm'
            ...
            <Container>
                ...
                <Section>
                    ...
                    <div>
                        ...
                        <label for="aceitar-termos">Aceito e estou de acordo com as condições.</label>
                    </div>

                        <button onClick={() => aceitouTermos()}> Aceitar Termos</button>
