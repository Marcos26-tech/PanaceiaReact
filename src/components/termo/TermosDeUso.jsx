  ...
  return (
    <Section>
      ...
      <p>
        ...
        página web. Qualquer um que sinta que uma mensagem postada é censurável
        é encorajado a notificar um administrador ou moderador da comunidade ou
        da página imediatamente. Os administrados e os proprietários desta
        página reservam-se o direito de remover conteúdo censurável, dentro de
        um prazo razoável, se determinarem que a remoção é necessária. Este é um
        processo manual, no entanto, por favor, perceba que eles podem não ser
        capazes de remover ou editar mensagens específicas imediatamente. Esta
        política também se aplica às informações do perfil dos usuários. Você
        permanece responsável pelo conteúdo de suas mensagens postadas. Os
        proprietários desta página web também se reservam o direito de não
        revelar suas identidades (ou quaisquer outras informações relacionadas
        coletadas neste serviço) no caso de uma reclamação formal ou ação
        judicial decorrente de qualquer situação causada pelo seu uso desta
        página web. Com esta conta de usuário que você está prestes a se
        registrar, você concorda em nunca dar sua senha para outra pessoa, para
        sua proteção e por razões de validade. Você também concorda em NUNCA
        usar a conta de outra pessoa por qualquer motivo. Também recomendamos
        que você use uma senha complexa e única para sua conta, para evitar o
        roubo de contas. Observe que a cada postagem, seu endereço IP é gravado,
        caso você precise ser banido desta página web ou do seu ISP contatado.
        Isso acontecerá no caso de violação deste acordo ou das diretrizes das
